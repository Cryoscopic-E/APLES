...
class PlanningProblem:
    ...
    def _init_goal(self, p=0, s=0, c=0):
        self.problem.add_goal(Equals(self.all_fluents['difficulty_lvl_physical'], p))
        self.problem.add_goal(Equals(self.all_fluents['difficulty_lvl_social'], s))
        self.problem.add_goal(Equals(self.all_fluents['difficulty_lvl_cognitive'], c))
